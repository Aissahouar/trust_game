...
class C(BaseConstants):
    ...
    NUM_ROUNDS = 1
    PERMUTATIONS = list(itertools.permutations(['questionnaire', 'trust_game', 'risk_aversion']))
...
class Dispatch(Page):
    ...
    def vars_for_template(player):
        ...
        return dict(
            ...
            group_number=(player.participant.id_in_session - 1) // 20 + 1  # Pour affichage si tu veux
        )
